...
function atualizarDisplay(prefixo = "") {
  ...
  document.getElementById("senhaAtualNumero").textContent = senhaAtual
    .toString()
    .padStart(4, "0");
  document.getElementById(
    "ultimaSenhaNumero"
  ).innerHTML = `<span style="color: #FFFF;">${prefixo} </span>${ultimaSenha
    .toString()
    .padStart(4, "0")}`;
...
function incrementarSenha() {
  ...
  let guicheAtual = parseInt(
    prompt("Digite o número do guichê (1-12) para a próxima senha:")
  );
